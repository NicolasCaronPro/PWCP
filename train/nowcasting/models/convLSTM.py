...
from Bureau.Dual_Model_Research.Model.LargeScale.train.config.config_convLSTM import DEVICE, seq_len
...
class ConvLSTM(nn.Module):
    ...
    # inputs: S*B*C*H*W
    def forward(self, inputs=None, states=None, seq_len=seq_len):
